...
class _CustomButtonState extends State<CustomButton> {
  ...
  void didChangeDependencies() {
    ...
    if (widget.style != null) {
      ...
      _color = widget.color ?? AppColors.primary;
      _hoverColor = AppColors.primary;
    ...
    if (widget.size != null) {
      ...
      _height = widget.height ?? 52.h;
      _textStyle = context.textThemes.bodyMedium;
      _iconBackgroundColor = AppColors.white;
      _iconColor = AppColors.black;
    }
    ...
    return GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
              ...
              border: _border,
              borderRadius: BorderRadius.circular(isLoading ? _height : 10.r)),
