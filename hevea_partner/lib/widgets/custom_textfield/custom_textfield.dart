...
class CustomTextField extends StatefulWidget {
  const CustomTextField({
    ...
    this.textFieldStyle = const TextStyle(
        color: Colors.black, fontFamily: dinNext, fontWeight: FontWeight.w200),
      ...
      children: [
        ...
        AnimatedContainer(
          ...
          decoration: BoxDecoration(
            color: widget.isEnabled ? AppColors.white : AppColors.disableGrey,
          ...
          child: Row(
            children: [
              ...
              const Spacer(),
              !widget.showIconLeading && widget.isPassword
                  ? GestureDetector(
                      onTap: () {
                        setState(() {
