...
import 'package:hevea_core/services/google_map_direction_services/polyline_result.dart';
...
class DirectionApi {
  ...
  Future<PolylineResult?> getRouteBetweenCoordinates() async {
    try {
      ...
      List<LatLng> points = [];
      final response = await http.get(Uri.parse('https://garage-cors.up.railway.app/${uri.toString()}')); //FIXME
