...
WidgetWithChildBuilder _materialContainerBuilder(BuildContext context,
  ...
  shape = shape ?? bottomSheetTheme.shape;
  clipBehavior = clipBehavior ?? bottomSheetTheme.clipBehavior ?? Clip.none;

  result(context, animation, child) =>
      Material(color: color, elevation: elevation!, shape: shape, clipBehavior: clipBehavior!, child: child);
  if (theme != null) {
