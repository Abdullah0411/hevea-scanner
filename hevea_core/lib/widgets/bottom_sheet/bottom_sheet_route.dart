...
class _ModalBottomSheet<T> extends StatefulWidget {
  ...
  final DModalBottomSheetRoute<T> route;
  final bool expanded;
  final bool bounce;
...
class DModalBottomSheetRoute<T> extends PageRoute<T> {
  DModalBottomSheetRoute({
    this.closeProgressThreshold,
  ...
  bool canTransitionFrom(TransitionRoute<dynamic> previousRoute) {
    ...
    try {
      if (previousRoute.settings.arguments != null) {
        isAnimated =
            (previousRoute.settings.arguments as Map)['isAnimated'] as bool;
      } else {
        isAnimated = true;
      }
    } catch (e) {
    ...
    return (previousRoute is DModalBottomSheetRoute ||
